...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Kakarot Safe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using Kakarot Safe</h4>
    <p>
      When visiting our website or using Kakarot Safe, we may collect and process personal data. The data will be stored
    ...
    <ol start={4}>
      <li>
        ...
        the Kakarot Safe, we process your
        <ol>
    ...
    <ol start={8}>
      <li>
        When we collect relevant&nbsp;data&nbsp;from the Blockchain to display context information in the Kakarot Safe
        we process:
        <ol>
          <li>your public Wallet address, </li>
          <li>account balance,</li>
    ...
    <p>
      4.2.2 For general operational analysis of the Kakarot Safe interface, monitoring transaction origins and measuring
    ...
    <p>
      In addition, we may take a recording of you while testing Kakarot Safe for internal and external use. The basis
    ...
    <p>
      Kakarot Safe mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the Kakarot Safe mobile app via biometrics information (touch ID or face ID). This is
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with Kakarot Safe. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>Kakarot Safe – Privacy policy</title>
      </Head>
